...
COMMANDS=("ufw default deny incoming" "ufw default allow outgoing" "ufw allow from $ADMIN_IP to any port 35222 proto tcp" "ufw allow 80/tcp" "ufw allow 443/tcp" "ufw deny 3306/tcp" "ufw --force enable")
printf '%s\n' "${COMMANDS[@]}"
