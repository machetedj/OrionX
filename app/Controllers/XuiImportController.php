...
final readonly class XuiImportController
{
 ...
 public function index(Request $r):void{$this->allow();$this->view->render('xui/index',['title'=>'Importar XUI One','connections'=>$this->repo->connections(),'imports'=>$this->repo->imports(),'uploads'=>$this->repo->uploads(),'csrf'=>$this->csrf]);}
