...
final readonly class PackageController
{
 ...
 public function index(Request $r):void{$this->allow();$this->view->render('packages/index',['title'=>'Packages','packages'=>$this->repo->all(),'categories'=>$this->repo->categories(),'categoryMap'=>$this->repo->categoryMap(),'bouquets'=>$this->repo->bouquets(),'bouquetMap'=>$this->repo->bouquetMap(),'csrf'=>$this->csrf]);}
