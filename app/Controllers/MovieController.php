...
final readonly class MovieController
{
 ...
 public function index(Request $r):void{$this->allow();$this->view->render('movies/index',['title'=>'Películas','movies'=>$this->repo->movies(),'categories'=>$this->repo->categories(),'libraries'=>$this->repo->libraries(),'packages'=>$this->repo->packages(),'csrf'=>$this->csrf]);}
