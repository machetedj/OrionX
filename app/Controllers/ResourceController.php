...
final readonly class ResourceController
{
 ...
 public function categories(Request $r):void{$this->show('categories','Categorías');} public function servers(Request $r):void{$this->show('servers','Servidores');} public function resellers(Request $r):void{$this->show('resellers','Revendedores');}
