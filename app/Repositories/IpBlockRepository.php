...
final readonly class IpBlockRepository
{
 ...
 public function blocks():array{return $this->db->query("SELECT b.*,u.name actor FROM blocked_ips b LEFT JOIN users u ON u.id=b.created_by ORDER BY b.active DESC,b.id DESC LIMIT 1000")->fetchAll();}
